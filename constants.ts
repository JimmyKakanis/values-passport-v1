...
export const TEACHERS: Teacher[] = [
  ...
  { name: 'Mrs Joanne Hirst', email: 'j.hirst@sathyasai.nsw.edu.au', role: 'TEACHER' },
  ...
  { name: 'Ms Michelle Moran', email: 'm.moran@sathyasai.nsw.edu.au', role: 'TEACHER' },
  { name: 'Ms Edwina Williams', email: 'e.williams@sathyasai.nsw.edu.au', role: 'TEACHER' },
  { name: 'Mr Clint Wilson', email: 'C.wilson@sathyasai.nsw.edu.au', role: 'TEACHER' },
  { name: 'Mr Aaron Shepherd', email: 'a.shepherd@sathyasai.nsw.edu.au', role: 'TEACHER' },
  { name: 'Mr Siva Muraliharan', email: 'businessmanager@sathyasai.nsw.edu.au', role: 'TEACHER' }
];
...
export const MOCK_STUDENTS: Student[] = [
  // --- TEST STUDENT ---
  createStudent('s-test-1', 'Student Test', 'Year 11', 'studenttest1@sathyasai.nsw.edu.au'),

  // Year 10
  createStudent('s1', 'Jimi Barron', 'Year 11'),
  createStudent('s2', 'Lexie Campbell', 'Year 11'),
  createStudent('s3', 'Radha Doyle', 'Year 11'),
  createStudent('s4', 'Jade Dwyer', 'Year 11'),
  createStudent('s5', 'Alfie Dyason Skelhorn', 'Year 11'),
  createStudent('s6', 'Jesse Harper', 'Year 11'),
  createStudent('s7', 'Nikita Mortimer Dafnis', 'Year 11'),
  createStudent('s8', 'Sonny Murphy', 'Year 11'),
  createStudent('s9', 'Penny O\'Brien', 'Year 11'),
  createStudent('s10', 'Finley Shore', 'Year 11'),
  createStudent('s11', 'Joseph Shore', 'Year 11'),
  createStudent('s12', 'Kai Vuurman', 'Year 11'),
  createStudent('s13', 'Asher Wagner', 'Year 11'),
  createStudent('s14', 'Bodhi Wilson', 'Year 11'),

  // Year 11
  createStudent('s15', 'Cayln Armstrong', 'Year 12'),
  createStudent('s16', 'Indira Arnold Freire', 'Year 12'),
  createStudent('s17', 'Calum Campbell', 'Year 12'),
  createStudent('s18', 'Reyannah De Guzman', 'Year 12'),
  createStudent('s19', 'Leah Ditton', 'Year 12'),
  createStudent('s20', 'Lola Dolan', 'Year 12'),
  createStudent('s21', 'Brooke Dwyer', 'Year 12'),
  createStudent('s22', 'Reuben English', 'Year 12'),
  createStudent('s23', 'Ginger Hobbins', 'Year 12'),
  createStudent('s24', 'Elliot Horvath', 'Year 12'),
  createStudent('s25', 'Odhran Ives', 'Year 12'),
  createStudent('s26', 'Jasper Pike', 'Year 12'),
  createStudent('s27', 'Thomas Spedding', 'Year 12'),
  createStudent('s28', 'Mikayla Stribling', 'Year 12'),
  createStudent('s29', 'Jacamo Symes', 'Year 12'),
  createStudent('s30', 'Charli Townsend Porter', 'Year 12'),

  // Year 12
  createStudent('s31', 'Maya Dan', 'Graduated 2025'),
  createStudent('s32', 'Seisha Doyle', 'Graduated 2025'),
  createStudent('s33', 'Mia Dyason Skelhorn', 'Graduated 2025'),
  createStudent('s34', 'Tyson Evans', 'Graduated 2025'),
  createStudent('s35', 'Jaylan Kershaw', 'Graduated 2025'),
  createStudent('s36', 'Ambrose Maiden', 'Graduated 2025'),
  createStudent('s37', 'Noah McInnes', 'Graduated 2025'),
  createStudent('s38', 'Kwey Moore', 'Graduated 2025'),
  createStudent('s39', 'Cooper Nuttall', 'Graduated 2025'),
  createStudent('s40', 'Ariel Oczak', 'Graduated 2025'),
  createStudent('s41', 'Nathaniel Withy', 'Graduated 2025'),
  createStudent('s42', 'Ami Zdesar', 'Graduated 2025'),

  // Year 7A
  createStudent('s43', 'Karmady de Graaf', 'Year 8'),
  createStudent('s44', 'Julian Farrell', 'Year 8'),
  createStudent('s45', 'Audrey Hilder', 'Year 8'),
  createStudent('s46', 'Delilah Hobbins', 'Year 8'),
  createStudent('s47', 'Dayal Johnson', 'Year 8'),
  createStudent('s48', 'Tanika Kennedy', 'Year 8'),
  createStudent('s49', 'Michelle Kerr', 'Year 8'),
  createStudent('s50', 'Harry Matisons', 'Year 8'),
  createStudent('s51', 'Spencer Mepstead', 'Year 8'),
  createStudent('s52', 'Aimi Perrot', 'Year 8'),
  createStudent('s53', 'Jy Pilon', 'Year 8'),
  createStudent('s54', 'Sol Sarson', 'Year 8'),
  createStudent('s55', 'Henry Scanlon', 'Year 8'),
  createStudent('s56', 'Willow Smith', 'Year 8'),
  createStudent('s57', 'Lenny Solomon', 'Year 8'),
  createStudent('s58', 'Archie Stanbury', 'Year 8'),
  createStudent('s59', 'Iluka Walton', 'Year 8'),
  createStudent('s60', 'Nina White', 'Year 8'),
  createStudent('s61', 'Sabarella Yuono', 'Year 8'),

  // Year 7B
  createStudent('s62', 'Tobi Bartesko', 'Year 8'),
  createStudent('s63', 'Sebastian Boudry', 'Year 8'),
  createStudent('s64', 'Makani Carlyle', 'Year 8'),
  createStudent('s65', 'Flynn Edmunds', 'Year 8'),
  createStudent('s66', 'Indiana Harper', 'Year 8'),
  createStudent('s67', 'Reggie Harrison', 'Year 8'),
  createStudent('s68', 'Hayden Lang', 'Year 8'),
  createStudent('s69', 'Pia Lindskog', 'Year 8'),
  createStudent('s70', 'Kai Lowlett Richards', 'Year 8'),
  createStudent('s71', 'Eli Macfie', 'Year 8'),
  createStudent('s72', 'Isla Morley', 'Year 8'),
  createStudent('s73', 'Rupert Oakman', 'Year 8'),
  createStudent('s74', 'Riley Parker', 'Year 8'),
  createStudent('s75', 'Lila Scapinello', 'Year 8'),
  createStudent('s76', 'Zoe Simiana', 'Year 8'),
  createStudent('s77', 'Ami-Ella Williams', 'Year 8'),
  createStudent('s78', 'Finley Williams', 'Year 8'),

  // Year 8A
  createStudent('s79', 'Ayla Barr', 'Year 9'),
  createStudent('s80', 'Scarlett Binns', 'Year 9'),
  createStudent('s81', 'Archie Butterworth', 'Year 9'),
  createStudent('s82', 'Talis Cortes De Lacy', 'Year 9'),
  createStudent('s83', 'Bella Dickinson', 'Year 9'),
  createStudent('s84', 'Ollie Gilfillan', 'Year 9'),
  createStudent('s85', 'Joli Hall', 'Year 9'),
  createStudent('s86', 'Sage Hansell', 'Year 9'),
  createStudent('s87', 'Marli Harper', 'Year 9'),
  createStudent('s88', 'Jahzarn Johnson', 'Year 9'),
  createStudent('s89', 'Spencer Kelly-Edwards', 'Year 9'),
  createStudent('s90', 'Zuri Noonan', 'Year 9'),
  createStudent('s91', 'Otis Pawson', 'Year 9'),
  createStudent('s92', 'Sari Sarson', 'Year 9'),
  createStudent('s93', 'Rose Trebilco', 'Year 9'),
  createStudent('s94', 'Eva Walshe', 'Year 9'),
  createStudent('s95', 'Kaida Watts', 'Year 9'),
  createStudent('s96', 'Luca Zar Quin Conroy', 'Year 9'),

  // Year 8B
  createStudent('s97', 'Tino Baggio', 'Year 9'),
  createStudent('s98', 'Billy Bevege', 'Year 9'),
  createStudent('s99', 'Chloe Boudry', 'Year 9'),
  createStudent('s100', 'Hayden Bray', 'Year 9'),
  createStudent('s101', 'Cohen Brown', 'Year 9'),
  createStudent('s102', 'Dixie Collins', 'Year 9'),
  createStudent('s103', 'Ether Cullen', 'Year 9'),
  createStudent('s104', 'Karna Atua Dahl', 'Year 9'),
  createStudent('s105', 'Flynn Day', 'Year 9'),
  createStudent('s106', 'Ayla Edwards', 'Year 9'),
  createStudent('s107', 'Herbie Harris', 'Year 9'),
  createStudent('s108', 'Rosie Jones', 'Year 9'),
  createStudent('s109', 'Marley Kershaw', 'Year 9'),
  createStudent('s110', 'Joonatan Mansbridge', 'Year 9'),
  createStudent('s111', 'Charlie McGregor', 'Year 9'),
  createStudent('s112', 'Stella McVicar', 'Year 9'),
  createStudent('s113', 'Mirabai Mitchell', 'Year 9'),
  createStudent('s114', 'Florence Penny', 'Year 9'),
  createStudent('s115', 'Hudson Prince', 'Year 9'),
  createStudent('s116', 'Marlee Stayt', 'Year 9'),
  createStudent('s117', 'Mollie Walsh', 'Year 9'),
  createStudent('s118', 'Ayisha Williams', 'Year 9'),

  // Year 9A
  createStudent('s119', 'Ace Carter', 'Year 10'),
  createStudent('s120', 'Xavier Clow', 'Year 10'),
  createStudent('s121', 'Jaci Ditton', 'Year 10'),
  createStudent('s122', 'Willow Hall', 'Year 10'),
  createStudent('s123', 'Joshua Hudson', 'Year 10'),
  createStudent('s124', 'Fianaid Ives', 'Year 10'),
  createStudent('s125', 'Jasper Pike', 'Year 10'),
  createStudent('s126', 'Lukas Suresh', 'Year 10'),

  // Year 9B
  createStudent('s127', 'Eden Bernard', 'Year 10'),
  createStudent('s128', 'Layla Dart', 'Year 10'),
  createStudent('s129', 'Ollie Davidson', 'Year 10'),
  createStudent('s130', 'Lucian Kearns', 'Year 10'),
  createStudent('s131', 'Izaak Law', 'Year 10'),
  createStudent('s132', 'Anabelle McInnes', 'Year 10'),
  createStudent('s133', 'Ebony Mepstead', 'Year 10'),
  createStudent('s134', 'Dylan O\'Brien', 'Year 10'),
  createStudent('s135', 'Nikolai O\'Brien', 'Year 10'),
  createStudent('s136', 'Stella O\'Hare', 'Year 10'),
  createStudent('s137', 'Thomas Oakman', 'Year 10'),
  createStudent('s138', 'Azaya Plard', 'Year 10'),
  createStudent('s139', 'Madeleine Scanlon', 'Year 10'),
